...
# Fixed Meesari wallet addresses (replace with real ones)
MEESARI_ETH = "0x000000000000000000000000000000000000dead"
MEESARI_SOL = "6VrkEwujanbChtqqDabAoZXKGkJKvjzcU9PDDL6Lce8x"  # replace with real Solana address
...
def get_eth_transactions(wallet):
    ...
    params = {
        ...
        "endblock": 99999999,
        "sort": "asc",
        "apikey": "TAU4QI8TQAZKR6FPI4ZKDGJ5EWFYB5M3GY"  # optional, free API key from etherscan.io
    }
    try:
...
def check_meesari_sol(wallet):
    signatures = get_sol_signatures(wallet, limit=10)  # check 10 tx for now
